...
<div class="jumbotron banertext bg12">
    <h1>JOB</h1>
</div>
    ...
    <div class="jumbotron">
            ...
            <div class="col-md-7">
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        ...
                        <p>
                            <b> We're one of the companies that provide elo boosting services all over the world. We
                                have a
                                clear mission, which is to make our customers as happy as possible. Together with our
                                elo
                                boosters we will deliver good, friendly and professional elo boosting services. Thanks
                                to
                                our customers we became the best website to date. We are constantly hiring league of
                                legends
        ...
        <div class="row">
            <div class="col-md-6">
                <h1>Professional</h1>
                <p>
                    If you want to work as a lol booster and become a part of our team you need to be ready to become a
                    part
            ...
            <div class="col-md-6">
                ...
                <p>
                    We take all elo booster who are committed and want to play and earn money , who are dedicated and
                    want
                    to become part of something bigger. If you are looking to earn money while playing your favorite
                    game
            ...
            <div class="col-md-6">
                ...
                <p>
                    ...
                    kindly ask from each of our elo booster to care about every customer so we can continue growing and
                    have
                    more and more orders from where our boosters will earn more and more money by playing league of
                    legends.
                </p>
            </div>
            <div class="col-md-6">
                ...
                <p>
                    ...
                    friendships, every single member of our team is equally valued and everyone of them is important to
                    us.
            ...
            <div class="col-md-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">We do not have any time requirements from our elo booster they are free to
                            play
            ...
            <div class="col-md-3 col-centered">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">It's really important for our elo boosters to have proper communication
                            skills
                            and have the ability to speak fluently at least English. It is important from the boosters
                            to be
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">High Elo Players</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <ul class="no_bullet">
                                    <li class="leaf">Minimum Rank to apply Diamond 1 – Euw</li>
                                    <li class="leaf">Minimum Rank to apply Diamond 1 – Na</li>
                                    <li class="leaf">Minimum Rank to apply Challenger – Eune</li>
                                    <li class="leaf">Minimum Rank to apply Challenger – Turkish</li>
                                    <li class="leaf">Minimum Rank to apply Challenger – Cis</li>
                                    <li class="leaf">Minimum Rank to apply Diamond 1 – Oceania</li>
        ...
        <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel1">Required Availability</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        We expect that every player will work at least 8 hours per day. We have high standards and we
                        want
                        to get the orders done as fast as possible. The average speed of our boosts is between 1-2
                        division
                        per day. If you're looking for the job and want to apply for a booster position we expect that
                        you
                        meet our requirements. I look forward to working together to provide great services to our
                        customers
                        and keep them happy.
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel12"
             aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel12">Required Languages</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 style="text-align: center">Apply to join the Top Boost Global team</h1>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="age">Age</label>
                            <input type="number" min="18" max="100" class="form-control" id="age" placeholder="Age">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="lanes">Main Lanes</label>
                            <input type="text" class="form-control" id="lanes" placeholder="Main Lanes">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="coaching"
                                   placeholder="Are you available to do coaching">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="specification"
                                   placeholder="Why you think you can become good booster?">
                        </div>
                        <div class="form-group">
                            <label for="goals">What is your main goal on this website?</label>
                            <input type="text" class="form-control" id="goals"
                                   placeholder="What is your main goal on this website?">
                        </div>
                        <div class="form-group">
